...
locals {
  ...
  valkey_hostname = var.existing_valkey_instance_crn != null ? data.ibm_database_connection.existing_connection[0].valkey[0].hosts[0].hostname : module.valkey[0].hostname
  valkey_port     = var.existing_valkey_instance_crn != null ? data.ibm_database_connection.existing_connection[0].valkey[0].hosts[0].port : module.valkey[0].port
}
